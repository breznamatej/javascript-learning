        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            <div class="product-quantity">
              ...
              <input class="quantity-input js-quantity-input js-quantity-input-${matchingProduct.id}" type="number" min="0" max="1000" placeholder="${cartItem.quantity}" data-product-id="${matchingProduct.id}">
